...
class EntryViewController: UIViewController {
    ...
    @IBOutlet weak var parentSelect: UIButton!
    
    @IBAction func parentButtonPressed(_ sender: Any) {
        isParent = true
        parentSelect.backgroundColor = UIColor.lightGray
        parentSelect.setTitleColor(UIColor.white, for: UIControlState.normal)
        
    }
    @IBAction func driverButtonPressed(_ sender: UIButton) {
        isParent = false
        driver.backgroundColor = UIColor.lightGray
        driver.setTitleColor(UIColor.white, for: UIControlState.normal)
